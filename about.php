...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm px-5 py-3 py-lg-0">
        <a href="index.php" class="navbar-brand p-0">
            <h1 class="m-0 text-primary"><img src="img/logos.png" height="60px" alt=""></i><span id="name">Sanjeevani Life Care Hospital</span></h1>
        </a>
    ...
    <!-- Hero Start -->
    <div class="container-fluid bg-primary hero-header1 py-5 hero-header mb-5">
        <div class="row py-3">
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-7">
                    ...
                    <h4 class="text-body fst-italic mb-4">Sanjeevani Life Care Hospital is a private hospital located in Abu Road, Rajasthan</h4>
                    <p class="mb-4">Sanjeevani Hospital has completed 20 years.As our specialist work, in work place 24*7 working hours and we have best specialist and provide best facilities</p>
                    <div class="row g-3">
                ...
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.9s" src="img/toshar.jpg" style="object-fit: cover;">
                    </div>
                </div>
            </div>
        </div>
